  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<%=basePath%>student/goQueryStudentsHasClass"> 增加</a> </li>
        <li>
...
function showPage(n) {
	$.ajax({
		...
		dataType : "text",
		url : "<%=basePath%>classroom/findAllClassroomIsNull",
		success : function(result) {
			...
			if(tl.list.length>0){
				$.each(tl.list, function(n,val){
				    ...
				    str+="<td><div class='button-group'><a class='button border-main' href='<%=basePath%>student/goQueryStudentsByClassroomId?id=" + val.classRoomId + "'><span class='icon-edit'></span>考场考生详情</a><a class='button border-red' href='javascript:void(0)' onclick='del(" + val.classRoomId + ")'><span class='icon-trash-o'></span>删除</a></div></td>"
				    str+="</tr>";
					$("#scores").append(str);
				})
			}else{
