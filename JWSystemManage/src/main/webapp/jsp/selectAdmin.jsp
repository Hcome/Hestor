...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<%=basePath%>">
      ...
      <div class="form-group">
        ...
        <div class="field">
          ${adminUser.getAdmin().getAdminNum()}
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          ${adminUser.getAdmin().getAdminName()}
          <div class="tips"></div>
        </div>
      </div>     
       ...
       <div class="form-group">
        ...
        <div class="field">
          ${adminUser.getAdmin().getAdminAge()}
          <div class="tips"></div>
        </div>
      </div>     
       <div class="form-group">
        ...
        <div class="field">
          ${adminUser.getAdmin().getAdminTel()}
          <div class="tips"></div>
        </div>
      </div>     
       <div class="form-group">
        ...
        <div class="field">
          ${adminUser.getAdmin().getAdminGender()}
          <div class="tips"></div>
        </div>
      </div>     
       ...
       <div class="form-group">
        ...
        <div class="field">
          ${adminUser.getAdmin().getAdminEmail()}
          <div class="tips"></div>
        </div>
      </div>  
    </form>
