...
function showPage(n) {
	$.ajax({
		...
		dataType : "text",
		url : "<%=basePath%>student/findNotClassStudent",
		success : function(result) {
			...
			if(tl.list.length>0){
				$.each(tl.list, function(n,val){
				    ...
				    str+="<td><div class='button-group'><a class='button border-main' href='<%=basePath%>student/addStudentIntoClass?id=" + val.studentId + "'><span class='icon-edit'></span>添加</a></div></td>"
				    str+="</tr>";
					$("#students").append(str);
				})
			}else{
