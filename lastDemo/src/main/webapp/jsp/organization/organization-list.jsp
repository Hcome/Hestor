...
<link rel="stylesheet" href="<%=basePath%>static/css/zTreeStyle/zTreeStyle.css">
...
<script type="text/javascript" src="<%=basePath%>jsp/organization/organization-list.js"></script>
<!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
<!--[if lt IE 9]>
