...
<link rel="stylesheet" href="<%=basePath%>static/css/kkpager_orange.css">
...
<script type="text/javascript" src="<%=basePath%>static/js/kkpager.min.js"></script>
...
<link rel="stylesheet" type="text/css" href="<%=basePath%>static/js/kkpager/jpager.css">
<script type="text/javascript" src="<%=basePath%>static/view/porchase/listPage.js"></script>
<script type="text/javascript">
        function load() {
